...
import javawebinar.webapp.util.LocalDateAdapter;
...
public class Organization implements Serializable {
    ...
    private javawebinar.webapp.model.Link link = javawebinar.webapp.model.Link.EMPTY;
    ...
    public Organization(String name, String url, Period... periods) {
        this(new javawebinar.webapp.model.Link(name, url), new LinkedList<>(Arrays.asList(periods)));
    }

    public Organization(javawebinar.webapp.model.Link link, List<Period> periods) {
        this.link = link;
        this.periods = periods;
    }

    public javawebinar.webapp.model.Link getLink() {
        return link;
    }
